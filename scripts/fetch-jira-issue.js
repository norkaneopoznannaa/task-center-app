...
async function main() {
  console.log('=== Fetching Jira Issue EGISZREMD-15282 ===\n');
  ...
  // Fetch issue
  console.log('\n3. Fetching issue EGISZREMD-15282...');
  const issueResult = await fetchJiraIssue('EGISZREMD-15282', loginResult.cookie);
  ...
  // Save to JSON
  const outputPath = path.join(process.env.USERPROFILE || '', 'Task_Center', 'data', 'jira-issue-EGISZREMD-15282.json');
